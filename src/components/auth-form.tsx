    ...
    <>
      ...
      <Form {...checkEmailForm} key={state}>
        ...
        >
          ...
          <Button
            type="submit"
            className="bg-sky-500 text-white hover:bg-sky-700 dark:bg-sky-500 dark:text-white dark:hover:bg-sky-700"
    ...
    <>
      ...
      <Form {...loginForm} key={state}>
        ...
        >
          ...
          <Button
            type="submit"
            className="bg-green-500 text-white hover:bg-green-700 dark:bg-green-500 dark:text-white dark:hover:bg-green-700"
...
export const CreateAccountForm = ({
  ...
  const createAccount = async (values: z.infer<typeof loginFormSchema>) => {
    try {
      ...
      toast({
        title: "Nazwa użytkownika albo numer telefonu juz jest w użyciu!",
